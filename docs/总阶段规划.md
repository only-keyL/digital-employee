...
> 文件驱动协作：GPT 负责规划与验收口径，Cursor 负责按 `阶段控制.md` 执行。每阶段完成后更新本文件「当前进度」。
...
- 编码冻结，无阶段十二
- 交付文档：`docs/MVP交付说明.md`、`docs/演示脚本.md`、`docs/本地启动说明.md`
- 后续优化：生产化 backlog（见 `MVP交付说明.md` 第 13 节），非当前开发阶段

## MVP 交付物索引

| 交付物 | 路径 |
|--------|------|
| 交付总览 | `docs/MVP交付说明.md` |
| 本地启动 | `docs/本地启动说明.md` |
| 演示脚本 | `docs/演示脚本.md` |
| 验收清单 | `docs/验收清单.md` |
| 企微生产接入 | `docs/企业微信接入指南.md` |
| 架构决策 | `docs/架构决策.md` |
| 执行记录 | `docs/执行记录.md` |
| 环境模板 | `.env.example` |
...
| 文件 | 用途 |
|------|------|
| `docs/阶段控制.md` | 当前阶段目标、禁止事项、执行模式 |
| `docs/验收清单.md` | 各阶段验收命令与通过标准 |
| `docs/架构决策.md` | 已确定架构决策（勿随意推翻） |
| `docs/执行记录.md` | Cursor 每轮执行记录 |
